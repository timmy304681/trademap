...
const { HERE_API_KEY, MAPTILER_API_KEY } = process.env;

router.get('/', (req, res) => {
  res.render('index', { title: '首頁', HERE_API_KEY, MAPTILER_API_KEY });
});
...
router.get('/product', (req, res) => {
  res.render('product', { title: '商品上傳頁面', HERE_API_KEY, MAPTILER_API_KEY });
});
...
router.get('/test', (req, res) => {
  res.render('here', { title: 'Here地圖', HERE_API_KEY, MAPTILER_API_KEY });
});
